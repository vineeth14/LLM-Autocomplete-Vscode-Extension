...
export class ContextRetrievalService {
     ...
     */
    async getContext(document: vscode.TextDocument, position: vscode.Position): Promise<ContextItem[]> {
     ...
     */
    private findFunctionDefinitions(document: vscode.TextDocument, position: vscode.Position): ContextItem[] {
     ...
     */
    private findVariableAssignments(document: vscode.TextDocument, position: vscode.Position): ContextItem[] {
     ...
     */
    private extractComments(document: vscode.TextDocument, position: vscode.Position): ContextItem[] {
